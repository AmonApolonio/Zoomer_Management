...
//Bloc to control the adding product feature
class ProductBloc extends BlocBase {
  final _dataController = BehaviorSubject<Map>();
  final _loadingController = BehaviorSubject<bool>();
  final _createdController = BehaviorSubject<bool>();

//stream that returns the product data
  Stream<Map> get outData => _dataController.stream;

//stream that returns if the save operation is loading
  Stream<bool> get outLoading => _loadingController.stream;

/*
stream that returns if the product is alredy created, 
it will be used to enable or not the delet button
*/
